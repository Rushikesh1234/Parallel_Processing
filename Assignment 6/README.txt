...
I have tried to execute this CUDA assignment. This is my first experience in CUDA, but i have tried to solve it. 

I have created one global cuda function, In that i am calculating (checking minimum distance value) value for row and column of matrix (a[i][k] and a[k][j]). 
